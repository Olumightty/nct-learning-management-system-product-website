  ...
  return (
    ...
    <section id='overview' className='bg-(--white) px-10 sm:px-20 py-20 flex flex-col md:flex-row gap-5 items-center justify-between' >
        <header className='self-start header'>
            ...
            <p className='text-xl md:text-2xl text-(--black) opacity-60 font-semibold mt-5'>Neo Cloud Learning Management System</p>
        </header>
        <article>
            <p className='text-lg md:text-xl text-(--black) opacity-80 max-w-[605px] mb-7'>The Neo Cloud Learning Management System is a user-friendly and comprehensive web-based platform designed to enhance the learning experience by allowing students to track their progress, monitor attendance, view classwork and projects, and request certificates upon course completion. It is built for Neo Cloud by Neo Cloud.It all includes:</p>
            <ul>
